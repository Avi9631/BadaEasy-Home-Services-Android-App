...
import com.service.badaeasy.HomeActivity;
import com.service.badaeasy.MainActivity;
import com.service.badaeasy.Models.ServicesModel;
import com.service.badaeasy.R;
import com.service.badaeasy.ServiceItem2Activity;
import com.service.badaeasy.ServiceItemActivity;
import com.service.badaeasy.ServicesBuyActivity;
import com.service.badaeasy.WebViewActivity;
...
public class ServiceAdapter  extends RecyclerView.Adapter<ServiceAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        else if(TYPE.equals("HOMEIMG")){
            View row = LayoutInflater.from(mContext).inflate(R.layout.img_home_item, parent, false);
            return new MyViewHolder(row);
        }
        else{
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mContext instanceof HomeActivity){
                        ...
                        else if (mData.get(position).getServicetype().equals("1")) {
